...
// @Success      200      {object}  map[string]any             "Notification request created successfully"
...
// @Success      200              {object}  map[string]any   "Notification cancelled successfully"
...
// @Success      200         {object}  map[string]any   "Notifications triggered with count"
